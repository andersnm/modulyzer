...
import { deletePatternEvents, exportClipboardPattern } from "../../components/PatternEditorHelper";
...
export class CutCommand implements ICommand {
    ...
    async handle(...args: any[]) {
        ...
        deletePatternEvents(this.app.song, patternEditor.renderColumns, start, end, startRow, endRow);
    }
}
